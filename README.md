...
<div align="center" markdown="1">
  ...
  [![Warp](https://github.com/user-attachments/assets/2bda420d-4211-4900-a37e-e3c7056d799c)](https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=ziq)<br>
  ### **[Warp, the intelligent terminal](https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=ziq)**<br>
  [Available for MacOS, Linux, & Windows](https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=ziq)<br>
  [Visit warp.dev to learn more](https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=ziq)
...
4. **Set the search engine name**:
   - Enter `Ziq` in the "Search engine" field.

5. **Set the search engine URL**:
   - Enter `https://ziq.ai?q=%s` in the "URL with %s in place of query" field.
...
After completing these steps, you should be able to use Ziq as your default search engine in Chrome.
...
2. Build the Docker image:
   ```bash
   docker build -t ziq.app .
   ```
3. Run the container:
   ```bash
   docker run --env-file .env -p 3000:3000 ziq.app
   ```
